 ...
 * 
 * @param <T> the type over which the metric operates
 */
public interface Metric<T> {
	...
	/**
	 * it is important to give a useful name here so that the output of experimental
	 * systems is correctly interpreted
	 * 
